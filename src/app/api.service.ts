...
export class ApiService {
  ...
  putTypeDataApi(types : string): Observable<any>{
    ...
    params.append('list_type',types); 
     return this.http.post(typeHomeUrl,params).pipe(map(this.extractData),catchError(this.handleError));
  }

  getAttendanceApi(types : string): Observable<any>{
    const params = new FormData();
    params.append('user_id',types); 
     return this.http.post(attendanceList,params).pipe(map(this.extractData),catchError(this.handleError));
  }
  ...
  getRecentList(types : string): Observable<any>{
    const params = new FormData();
    params.append('user_id',types); 
     return this.http.post(recentList,params).pipe(map(this.extractData),catchError(this.handleError));
  }
  ...
  getinboxApi(types : string): Observable<any>{
    const params = new FormData();
    params.append('user_id',types); 
     return this.http.post(inboxList,params).pipe(map(this.extractData),catchError(this.handleError));
  }
  ...
  getToDoApi(ids : string): Observable<any>{
    ...
    params.append('user_id',ids); 
     return this.http.post(todoList,params).pipe(map(this.extractData),catchError(this.handleError));
  }

  getGalleryUser(ids : string): Observable<any>{
    const params = new FormData();
    params.append('user_id',ids); 
     return this.http.post(userGallery,params).pipe(map(this.extractData),catchError(this.handleError));
  }

  getGalleryAll(ids : string): Observable<any>{
    const params = new FormData();
    params.append('institute_id',ids); 
     return this.http.post(gList,params).pipe(map(this.extractData),catchError(this.handleError));
  }
  ...
  getSellList(ids : string): Observable<any>{
    const params = new FormData();
    params.append('user_id',ids); 
     return this.http.post(buyList,params).pipe(map(this.extractData),catchError(this.handleError));
  }

   productCate(ids : string): Observable<any>{
    const params = new FormData();
    params.append('user_id',ids); 
     return this.http.post(buyCate,params).pipe(map(this.extractData),catchError(this.handleError));
  }

  inslist(ids : string): Observable<any>{
    const params = new FormData();
    params.append('user_id',ids); 
     return this.http.post(insList,params).pipe(map(this.extractData),catchError(this.handleError));
  }



  sendTodo(id : string,matter:string,one:string,priority:string,datetime:string): Observable<any>{
    const params = new FormData();
    ...
    return this.http.post(addToDo,params).pipe(map(this.extractData),catchError(this.handleError));
  }

  sendBooks(id : string,cate:string,name:string,desc:string,price:string): Observable<any>{
    const params = new FormData();
    params.append('user_id',id); 
    ...
    return this.http.post(sendBUrls,params).pipe(map(this.extractData),catchError(this.handleError));
  }

  sendNotes(id : string,cate:string,name:string,desc:string,price:string): Observable<any>{
    const params = new FormData();
    params.append('user_id',id); 
    params.append('product_category',cate); 
    params.append('product_name',name); 
  ...
  sendReports(id : string,cate:string,name:string,desc:string,price:string): Observable<any>{
    const params = new FormData();
    params.append('user_id',id); 
    params.append('product_category',cate); 
    params.append('product_name',name); 
  ...
  sendOthes(id : string,cate:string,name:string,desc:string,price:string): Observable<any>{
    const params = new FormData();
    params.append('user_id',id); 
    params.append('product_category',cate); 
    params.append('product_name',name); 
  ...
  putDirectory(types : string): Observable<any>{
    const params = new FormData();
     return this.http.post(direUrl,params).pipe(map(this.extractData),catchError(this.handleError));
  }
